...
// This code throws a ReferenceError because let variables exhibit different hoisting behavior compared to var. 
// While let declarations are hoisted to the top of their scope, they remain in a Temporal Dead Zone (TDZ) and stay uninitialized until the actual declaration line is reached. 
// Unlike var which gets initialized as undefined during the Memory Creation Phase, 
// let variables cannot be accessed before initialization. When we try to assign age = 100 and access it via console.log, JavaScript throws 'Cannot access age before initialization' error. This demonstrates let's block-scoping and TDZ mechanism which prevents accidental variable usage and makes code more predictable.
